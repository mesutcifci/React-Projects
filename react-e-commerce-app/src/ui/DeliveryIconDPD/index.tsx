  ...
  return (
    <SvgIcon {...{ viewBox, width, height, sx }} data-testid={id}>
      <g fillRule="evenodd">
        ...
        />
        <g fill="#dc0032">
          <path d="m1.947 3.683-.233.127 2.308 2.71.698.401zm5.186 6.456 1.1 1.27v-.402l-.401-.466zm2.73 2.773v.402l4.001 4.678.233-.127z" />
          <path d="m1.757 3.789-.233.127 1.968 2.307.678.38zm4.826 6.053 1.65 1.905v-.402l-.952-1.122zm3.28 3.387v.402l3.81 4.466.233-.127z" />
          <path d="m1.566 3.895-.233.127 1.61 1.883.676.381zm4.488 5.63 2.18 2.54v-.402l-1.504-1.757zm3.81 4.043v.402l3.64 4.233.233-.127z" />
          <path d="m1.376 4-.233.127 1.249 1.461.677.38zm4.127 5.207 2.73 3.175v-.402l-2.051-2.37zm4.36 4.678v.402l3.45 4.022.234-.127z" />
          <path d="m1.185 4.106-.233.127.89 1.037.677.403zm3.768 4.784 3.28 3.831v-.402l-2.603-3.027zm4.91 5.313v.402l3.26 3.81.233-.127z" />
          <path d="m.995 4.212-.233.127.53.614.698.402zm3.408 4.382 3.83 4.445v-.403l-3.153-3.661zm5.46 5.947v.403l3.07 3.577.233-.127z" />
          <path d="m.804 4.297-.254.127.19.233.7.38zm3.048 3.98 4.382 5.1v-.423l-3.684-4.297zm6.012 6.582v.402l2.878 3.387.233-.148z" />
          <path d="m.614 4.403-.148.084.423.233zm2.688 3.556 4.932 5.736v-.402l-4.234-4.933zm6.562 7.217v.424l2.709 3.154.233-.149z" />
        ...
        <path
          d="m1.122 6.71 7.112 8.276v-.402l-6.435-7.472zm8.742 9.779v.402l1.947 2.286.233-.127z"
          fill="#db0032"
        />
        <path
          d="m.571 6.392 7.663 8.933v-.403l-6.985-8.128zm9.293 10.414v.402l1.778 2.075.232-.127z"
          fill="#da0032"
        />
        <path
          d="m.021 6.096 8.213 9.546v-.402l-7.514-8.763-.7-.381zm9.843 11.028v.423l1.587 1.842.233-.127z"
          fill="#d90032"
        />
        <path
        ...
        />
        <path
          d="m0 6.625v.402l8.234 9.589v-.402zm9.715 11.325c0 .021 0 .021-.02.021l-.212.127 1.397 1.609.232-.127z"
          fill="#d60032"
        />
        <path
          d="m0 6.943v.402l8.234 9.588v-.402zm9.546 11.112-.254.148 1.418 1.63.233-.148z"
          fill="#d50032"
        />
        <path
          d="m0 7.281v.402l8.234 9.589v-.402zm9.356 10.88-.149.085c-.042.02-.084.02-.127.02l1.44 1.673.233-.148z"
          fill="#d40032"
        />
        <path
        ...
        />
        <path
          d="m0 7.916v.424l10.139 11.81.233-.148-1.524-1.778-.466-.254a.294.294 0 0 1 -.148-.254v-.211z"
          fill="#d20032"
        />
        ...
        <path
          d="m0 9.546v.402l9.186 10.71c.064-.02.127-.042.19-.063l.064-.042z"
          fill="#cd0032"
        />
        <path
          d="m0 9.864v.423l8.911 10.372h.127c.064 0 .127 0 .19-.022z"
          fill="#cc0032"
        />
        <path
          d="m0 10.202v.402l8.424 9.822.297.169c.063.042.169.064.254.064z"
          fill="#cb0032"
        />
        ...
        <path
          d="m0 15.07v.106c0 .212.148.466.317.572l.508.275-.825-.952z"
          fill="#bc0033"
        />
...
export default DeliveryIconDPD;
